import getLocation from './getCurLongLat';
...
function sendFutureText(inputName, inputFriendNumber, inputLocation, inputTime) {
    ...
    setTimeout(textFriendNow, millisecondTimer, inputName, inputLocation, inputFriendNumber, inputTime);
...
function textFriendNow(inputName, inputLocation, inputFriendNumber, inputTime) {
